...
To download this repo and all the submodules you must use git clone --recurse-submodules [git@github.com:stiles69/lib.git](git@github.com:stiles69/lib.git)
